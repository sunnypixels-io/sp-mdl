...
add_action( 'tgmpa_register', 'sp_mdl_register_required_plugins' );
 ...
 */
function sp_mdl_register_required_plugins() {
	/*
	...
	$plugins = array(
        ...
        */
		...
		array(
            ...
            'required'     => false,
            'external_url' => 'https://shortpixel.com/free-sign-up-referrer/referrer/668215',
            'tags'         => 'performance'
        ),

        array(
            'name'      => 'HTML Global lang Attribute',
            'slug'      => 'html-global-lang-attribute',
            'required'  => false,
            'tags'      => 'seo, author'
        ),
